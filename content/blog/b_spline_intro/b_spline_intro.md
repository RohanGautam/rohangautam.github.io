...
{% image "Pasted image 20240618150758.png","Curves with different continuities in different columns" %}
...
{% image "Pasted image 20240617111409.png","Cubic spline basis functions" %}
...
{% image "Pasted image 20240618110327.png","Basis functions for the fit" %}
And here's our B-spline!
{% image "Pasted image 20240618110405.png","Our fitted B-spline on example data" %}
